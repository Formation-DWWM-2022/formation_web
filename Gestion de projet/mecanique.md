...
## 2.3 Logo
« Le Garage BELDON Didier  » se réserve le droit de fournir directement le logo à utiliser. Si le prestataire souhaite proposer un logo, il peut alors proposer un devis pour le logo séparé du devis global.
...
Le site se décompose en 6 pages principales, toutes accessibles depuis le header du site, lui-même présent à l’identique sur l’ensemble des pages du site. Ces pages principales sont :
    ...
    Home (http://legaragebeldondidier)
    Nos pneus (http://legaragebeldondidier/nos-pneus)
    Nos coffrets (http://legaragebeldondidier/nos-coffrets)
    Nos fournisseurs (http://legaragebeldondidier/nos-fournisseurs)
    Qui sommes-nous ? (http://legaragebeldondidier/qui-sommes-nous)
    Blog (http://legaragebeldondidier/blog)
    Espace Client (http://legaragebeldondidier/mon-compte)
...
En plus des ces pages principales, les pages suivantes doivent être accessibles depuis le footer :
    ...
    Aide
        FAQ
        Mentions légales (http://legaragebeldondidier/mentions-legales)
        Contact (http://legaragebeldondidier/nous-contacter)
    Presse (http://legaragebeldondidier/presse)
    Qui sommes-nous ? (http://legaragebeldondidier/qui-sommes-nous)
    Blog (http://legaragebeldondidier/blog)

## 3.2 Description fonctionnelle du site :

Boutique en ligne n°1 : Nos pneus
Le site de « Le Garage BELDON Didier » doit bien évidemment comporter une boutique en ligne, accessible depuis l’onglet « Nos pneus ». Cette boutique en ligne doit par défaut afficher l’ensemble des pneus mis en ligne depuis le back-office, et disponibles en stocks, classés par ordre de prix croissant.
...
En plus de l’achat à la bouteille, « Le Garage BELDON Didier » permettra d’acheter des « coffrets » de plusieurs pneus. La vente de coffrets s’effectuera depuis une boutique en ligne séparée et simplifiée, listant les différents coffrets.
Depuis la liste de chaque produit, les utilisateurs doivent pouvoir :
...
Blog
« Le Garage BELDON Didier » disposera également d’un blog, composé d’une page principale listant les articles classés par date.

## 3.3 Description fonctionnelle du Back-office :

Depuis le back-office, l’équipe de « Le Garage BELDON Didier » doit être en mesure d’effectuer en autonomie l’ensemble des tâches quotidiennes nécessaires au bon fonctionnement du site ecommerce.
...
3.5 Contraintes techniques :
    ...
    L’hébergeur sera sélectionné et l’hébergement paramétré par le prestataire, mais directement facturé à « Le Garage BELDON Didier ».
...
4.1 Prestations attendues :
    ...
    L’hébergeur doit être sélectionné et l’hébergement paramétré par le prestataire, mais directement facturé à « Le Garage BELDON Didier ».
    ...
    Formation à la gestion du site : Le prestataire devra organiser une formation pour l’équipe de « Le Garage BELDON Didier » ainsi qu’un document d’aide décrivant les actions à effectuer pour la bonne gestion des activités courantes.
    Accompagnement marketing : Le prestataire peut être force de proposition. Tous les éléments relatifs à l’accompagnement marketing (SEO, SEA, webanalyse, Social Media) devront être proposés dans une section du devis bien distincte. « Le Garage BELDON Didier » s’offre la possibilité de travailler avec différents prestataires pour la gestion des activités marketing et la création du site internet.
...
« Le Garage BELDON Didier » sera propriétaire de lʼensemble des images, graphismes, icônes et autres contenus créés pour le site. Le prestataire s’engage également à transmettre ses droits de propriété, d’exploitation, de reproduction, d’adaptation, de distribution et de traduction sur l’ensemble du site, ainsi que le code source et l’ensemble des accès à « Le Garage BELDON Didier » lors de la mise en production initiale.
...
Afin de candidater, le prestataire devra impérativement fournir :
    ...
    Potentielles difficultés identifiées : Ne pas hésiter à souligner les points qui pourraient avoir été mal anticipés ou mal conçus par « Le Garage BELDON Didier ».
