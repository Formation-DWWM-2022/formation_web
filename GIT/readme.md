...
Le but ici est de proposer vos modifications à mon projet original, pour se faire, sur la page du projet, cliquez sur le bouton de "pull request", vous ne pouvez pas le manquer il est à gauche et vert.
