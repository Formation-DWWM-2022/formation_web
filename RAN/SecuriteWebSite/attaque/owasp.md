...
1. [Injection - A01:2021 - Injection](./owasp/InjectionSQL.md) <!-- pas finis -->
...
2. [Piratage de session - A02:2021 - Broken Authentification](./owasp/PiratageSession.md) <!-- pas finis -->
...
3. [Exposition de données sensibles - A03:2021 - Sensitive Data Exposure](./owasp/expositionDonne.md)
...
4. Entités externes XML (XXE) - A04:2021 - XML External Entities (XXE)
...
5. Contournement du contrôle d’accès - A05:2021 - Broken Access Contr
...
6. Security Misconfiguration - A06:2021 - Security Misconfiguration
...
7. Cross-Site Scripting  (XSS) - A07:2021 - Cross-Site Scripting (XSS)
...
8. Désérialisation non sécurisée (Insecure Deserialisation) - A08:2021 - Insecure Deserialization
...
9. Utilisation de composants présentant des vulnérabilités connues - A09:2021 - Using Components with Known Vulnerabilitie
...
10. Manque de surveillance et de monitoring - A010:2021 - Insufficient Logging & Monitoring
...
1. Contrôle d’accès brisé A01:2021
...
5. Inconduite en matière de sécurité A05:2021
...
9. Échec de la journalisation et de la surveillance de la sécurité A09:2021
