...
![une fonction retourne un résultat à partir de paramètres](./img/g.png)
...
![appel de multiplierParDeux(3)](./img/gmultiplierParDeux.png)
...
![appel de multiplierParDeux(3)](./img/gmultiplierParDeuxV2.png)
...
[Solution](./exercices/2-solutions/3-fonctions.js)
...
![test de la fonction multiplierParDix()](./img/gmultiplierParDix.png)
...
[Solution de la phase 1](./exercices/2-solutions/4-chifoumi-phase-1.js)
[Solution de la phase 2](./exercices/2-solutions/4-chifoumi-phase-2.js)